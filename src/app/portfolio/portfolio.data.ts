...
export const projects: ProjectInterface[] = [
  {
    ...
    description: {
      ...
      de : 'Aufgabenmanager inspiriert vom Kanban-System. Erstellen und organisieren von Aufgaben per Drag & Drop, mit Zuweisung von Benutzern und Kategorien.',
    },
    githubUrl: 'https://github.com/goninski/DA-JOIN',
    demoUrl: 'https://da-join.goninski.dev',
  ...
  },
  {
    ...
    title: 'Bubble',
    description: {
      en : 'This is a Slack Clone App. It revolutionizes team communication and collaboration with its intuitive interface, real-time messaging, and robust channel organization.',
      de : 'Diese ist eine Slack Clone App. Sie revolutioniert die Teamkommunikation und Zusammenarbeit mit einer intuitiven Benutzeroberfläche, Echtzeit-Messaging und robustem Kanalmanagement.',
    },
    githubUrl: 'https://github.com/goninski/DA-bubble',
    demoUrl: 'https://da-bubble.goninski.dev',
